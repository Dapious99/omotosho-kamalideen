      ...
      <div className="container mx-auto px-6 md:px-12 py-12">
        ...
        >
          <div className="flex items-center justify-between pb-4">
            <p className="font-playfair text-xl md:text-2xl">Get in touch</p>
          ...
          <p className="font-playfair text-2xl text-justify md:text-6xl text-[#C9A000]">
          ...
          <div className="flex gap-4 md:gap-10 flex-col md:flex-row">
            ...
            <div className="text-xl md:text-2xl font-medium">
              ...
              <div className="text-[#C9A000] flex flex-col gap-4">
                <a
